    ...
    <main className="bg-no-repeat bg-cover h-screen w-screen flex items-center justify-center bg-center"
      ...
      <div className="flex flex-col gap-3 sm:gap-5 backdrop-blur-xl bg-white/75 p-8 lg:p-12 rounded-lg shadow-lg w-4/5 sm:w-3/5">
        ...
        <div className="space-y-3 lg:text-xl">
          ...
          <p>
            Today I am in <span className="text-base bg-amber-100 px-2 py-1 rounded-xl">🇯🇵⛩️ Tokyo, Japan</span>, you can follow me on <a className="text-[#E4405F] font-medium hover:underline" href="https://www.instagram.com/gleb.skibitsky/" target="_blank" rel="noreferrer">Instagram</a> or <a className="text-[#1DA1F2] font-medium hover:underline" href="https://twitter.com/skibitsky" target="_blank" rel="noreferrer">Twitter</a> for updates.
          </p>
          <p>
